...
namespace pcl_aggregator {
    namespace cuda {
        ...
        /*! \brief PointCloud utilities accelerated by CUDA. */
        class CUDAPointClouds {
            public:
                 ...
                 * */
                __host__ static void setPointCloudLabelCuda(pcl::PointCloud<pcl::PointXYZRGBL>::Ptr cloud, std::uint32_t label);
                 ...
                 */
                __host__ static void transformPointCloudCuda(pcl::PointCloud<pcl::PointXYZRGBL>::Ptr, Eigen::Affine3d transform);
